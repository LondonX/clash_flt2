...
env GOOS=android GOARCH=arm GOARM=7 CC=/Users/london/Library/Android/sdk/ndk/26.0.10792818/toolchains/llvm/prebuilt/darwin-x86_64/bin/armv7a-linux-androideabi26-clang CGO_ENABLED=1 go build -ldflags="-w -s" -buildmode=c-shared -o ./dist/android/armeabi-v7a/libclash.so
echo "  > Build for arm64-v8a"
env GOOS=android GOARCH=arm64 CC=/Users/london/Library/Android/sdk/ndk/26.0.10792818/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android34-clang CGO_ENABLED=1 go build -ldflags="-w -s" -buildmode=c-shared -o ./dist/android/arm64-v8a/libclash.so
